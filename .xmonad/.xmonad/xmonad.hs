...
myFont :: String
myFont = "xft:FantasqueSansMono Nerd Font:regular:size=9:antialias=true:hinting=true"
...
myEmacs :: String
myEmacs = "code . "  -- Makes emacs keybindings easier to type
...
myStartupHook = do
   ...
   --  spawnOnce "feh --randomize --bg-fill /home/alpha/Documents/customization/wallpapers"  -- feh set random wallpaper
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        , ("M-o", spawn "rofi -show {run,drun,window} -theme ~/.config/rofi-collection/dracula/dracula.rasi") -- Dmenu

    -- KB_GROUP Other Dmenu Prompts
    -- In Xmonad and many tiling window managers, M-p is the default keybinding to
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        , ("M-p ", spawn "rofi -show run")    -- choose an ambient background
    ...
    -- KB_GROUP Windows navigation
        ...
        , ("M-d", spawn("nohup snap run discord &"))       -- Rotate all the windows in the current stack
...
main = do
    ...
    xmproc1 <- spawnPipe "bash ~/.config/polybar/material/scripts/random.sh"
    xmproc2 <- spawnPipe "bash ~/.config/polybar/launch.sh --shapes"
