        ...
        try {
            switch (normalizedInfo.language) {
                ...
                case "mermaid": {
                    ...
                    $output = `<div ${attributes_1.stringifyAttributes(ensureClassInAttributes(normalizedInfo.attributes, normalizedInfo.language))}>${utility_1.escapeString(code)}</div>`;
                    break;
                }
                case "zenuml":
                case "seq":
                case "sequence-diagram": {
                    ...
                    $output = `<div ${attributes_1.stringifyAttributes(ensureClassInAttributes(normalizedInfo.attributes, normalizedInfo.language))}><sequence-diagram>${code}</sequence-diagram></div>`;
                    break;
                }
                case "wavedrom": {
                ...
                case "plantuml": {
                    ...
                    if (!svg) {
                        svg = yield puml_1.render(code, fileDirectoryPath, plantumlServer);
                ...
                case "ditaa": {
                    ...
                    const svg = yield ditaa_1.render(code, args);
                    $output = `<p ${attributes_1.stringifyAttributes(normalizedInfo.attributes)}>${svg}</p>`;
                    break;
                }
            }
