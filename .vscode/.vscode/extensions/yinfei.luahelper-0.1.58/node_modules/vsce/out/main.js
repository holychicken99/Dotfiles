...
module.exports = function (argv) {
    ...
    program
        ...
        .action((version, { out, message, gitTagVersion, githubBranch, gitlabBranch, baseContentUrl, baseImagesUrl, yarn, ignoreFile, gitHubIssueLinking, gitLabIssueLinking, }) => main(package_1.packageCommand({
        packagePath: out,
        version,
    ...
    program
        ...
        .option('--noVerify')
        .option('--ignoreFile [path]', 'Indicate alternative .vscodeignore')
        .action((version, { pat, message, gitTagVersion, packagePath, githubBranch, gitlabBranch, baseContentUrl, baseImagesUrl, yarn, noVerify, ignoreFile, }) => main(publish_1.publish({
        pat,
        version,
        commitMessage: message,
        gitTagVersion,
