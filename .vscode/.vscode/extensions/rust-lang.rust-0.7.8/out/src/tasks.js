...
function runTaskCommand({ command, args, env, cwd }, displayName, folder) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const task = new vscode_1.Task({ type: 'shell' }, folder || vscode_1.workspace.workspaceFolders[0], displayName, TASK_SOURCE, new vscode_1.ShellExecution(commandLine, {
        ...
        return new Promise(resolve => {
            const disposable = vscode_1.tasks.onDidEndTask(({ execution }) => {
                ...
                if (taskExecution instanceof vscode_1.ShellExecution &&
