...
import { assertNotInAttributes, assertNotInSkip, assertInAttributes, assertCloseMatchesOpenTag, setInAttributes, } from './assertions';
/**
...
var ref = function (id) { return function (element) {
...
var rawString = function (value) {
    ...
    if (process.env.NODE_ENV !== 'production') {
        if (typeof value !== 'string') {
            throw new Error('Tried to create a RawString from non-string value: ' +
