...
exports.ls = exports.listFiles = exports.packageCommand = exports.pack = exports.collect = exports.createDefaultProcessors = exports.processFiles = exports.toContentTypes = exports.toVsixManifest = exports.readManifest = exports.validateManifest = exports.ValidationProcessor = exports.NLSProcessor = exports.WebExtensionProcessor = exports.isWebKind = exports.isSupportedWebExtension = exports.ChangelogProcessor = exports.ReadmeProcessor = exports.MarkdownProcessor = exports.TagsProcessor = exports.ManifestProcessor = exports.versionBump = exports.BaseProcessor = exports.read = void 0;
const fs = require("fs");
...
function versionBump(cwd = process.cwd(), version, commitMessage, gitTagVersion = true) {
...
class ManifestProcessor extends BaseProcessor {
    constructor(manifest) {
        ...
        this.vsix = Object.assign(Object.assign({}, this.vsix), { id: manifest.name, displayName: manifest.displayName || manifest.name, version: manifest.version, publisher: manifest.publisher, engine: manifest.engines['vscode'], description: manifest.description || '', categories: (manifest.categories || []).join(','), flags: flags.join(' '), links: {
                repository,
    ...
    onFile(file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({}, file), { mode: 0o100644 });
        });
    }
    onEnd() {
        return __awaiter(this, void 0, void 0, function* () {
...
class WebExtensionProcessor extends BaseProcessor {
    ...
    onEnd() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isWebKind) {
                this.vsix = Object.assign(Object.assign({}, this.vsix), { webExtension: true });
...
function toContentTypes(files) {
    const extensions = Object.keys(_.keyBy(files, f => path.extname(f.path).toLowerCase()))
        .filter(e => !!e)
        .reduce((r, e) => (Object.assign(Object.assign({}, r), { [e]: mime_1.lookup(e) })), {});
    const allExtensions = Object.assign(Object.assign({}, extensions), defaultExtensions);
...
function readIgnoreFile(cwd, ignoreFile) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return yield readFile(ignoreFile ? ignoreFile : path.join(cwd, '.vscodeignore'), 'utf8');
        }
        catch (err) {
...
function collectFiles(cwd, useYarn, dependencyEntryPoints, ignoreFile) {
    return __awaiter(this, void 0, void 0, function* () {
        const files = (yield collectAllFiles(cwd, useYarn, dependencyEntryPoints)).filter(f => !/\r$/m.test(f));
        const rawIgnore = yield readIgnoreFile(cwd, ignoreFile);
        return ignore_1.default().add(defaultIgnore).add(rawIgnore).add(notIgnored).filter(files);
    });
}
    ...
    return Promise.all(processedFiles).then(files => {
        return util.sequence(processors.map(p => () => p.onEnd())).then(() => {
            ...
            const tags = _(_.flatten(processors.map(p => p.tags)))
                ...
                .compact() // remove falsey values
                .join(',');
            const vsix = processors.reduce((r, p) => (Object.assign(Object.assign({}, r), p.vsix)), { assets, tags });
...
function packageCommand(options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        yield versionBump(options.cwd, options.version, options.commitMessage, options.gitTagVersion);
