...
module.exports = function (argv) {
    ...
    program
        ...
        .action((version, { out, message, gitTagVersion, githubBranch, gitlabBranch, baseContentUrl, baseImagesUrl, yarn, ignoreFile, gitHubIssueLinking, gitLabIssueLinking, web, }) => main(package_1.packageCommand({
        packagePath: out,
        version,
    ...
    program
        ...
        .option('--ignoreFile [path]', 'Indicate alternative .vscodeignore')
        .option('--web', 'Experimental flag to enable publishing web extensions. Note: This is supported only for selected extensions.')
        .action((version, { pat, message, gitTagVersion, packagePath, githubBranch, gitlabBranch, baseContentUrl, baseImagesUrl, yarn, noVerify, ignoreFile, web, }) => main(publish_1.publish({
        pat,
        version,
        commitMessage: message,
        gitTagVersion,
    ...
    program
        ...
        .action((name, { pat }) => main(store_1.verifyPat(pat, name)));
    program
